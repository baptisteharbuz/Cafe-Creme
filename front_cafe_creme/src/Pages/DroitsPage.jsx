...
const droits = () => {
    return (<>
        <div className="container-droits">
            <h2>Politique de confidentialité</h2>
            <p>
                Politique de confidentialité
                Le site web cafecreme.fr est détenu par Café Crème, qui est un contrôleur de données de vos données personnelles.
            </p>
            <p>
                Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par cafecreme.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de cafecreme.fr.
            </p>
            <p>
            ...
            <p>
                ...
                Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à contact@cafecreme.fr.
            </p>
        </div>
    </>);
}
